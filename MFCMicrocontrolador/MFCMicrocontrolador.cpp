...
// MFCMicrocontrolador.cpp: define los comportamientos de las clases para la aplicación.
//
...
// CMFCMicrocontroladorApp

BEGIN_MESSAGE_MAP(CMFCMicrocontroladorApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CMFCMicrocontroladorApp

CMFCMicrocontroladorApp::CMFCMicrocontroladorApp()
{
...
// Único objeto CMFCMicrocontroladorApp

CMFCMicrocontroladorApp theApp;


// Inicialización de CMFCMicrocontroladorApp

BOOL CMFCMicrocontroladorApp::InitInstance()
{
